...
app.post("/submit", (req, res) => {
  ...
  let randomAdj = adj[Math.round(Math.random() * adj.length)];
  let randomNoun = noun[Math.round(Math.random() * noun.length)];

  let bandNameData = {
    adj : randomAdj,
    noun : randomNoun
  }
  res.render("index.ejs", bandNameData)
});
